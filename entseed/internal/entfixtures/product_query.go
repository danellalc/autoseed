...
func (_q *ProductQuery) QueryTags() *TagQuery {
...
func (_q *ProductQuery) WithTags(opts ...func(*TagQuery)) *ProductQuery {
	query := (&TagClient{config: _q.config}).Query()
...
func (_q *ProductQuery) loadTags(ctx context.Context, query *TagQuery, nodes []*Product, init func(*Product), assign func(*Product, *Tag)) error {
