...
func (_c *ProductCreate) AddTagIDs(ids ...int) *ProductCreate {
	_c.mutation.AddTagIDs(ids...)
	return _c
}

// AddTags adds the "tags" edges to the Tag entity.
func (_c *ProductCreate) AddTags(v ...*Tag) *ProductCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ProductCreate) check() error {
	if _, ok := _c.mutation.Sku(); !ok {
		return &ValidationError{Name: "sku", err: errors.New(`entfixtures: missing required field "Product.sku"`)}
	}
	return nil
}
